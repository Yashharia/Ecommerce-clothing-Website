...
This T&C is effective upon your subscription and governs the relationship between you and Marble E-retail Private Limited (hereinafter "Company") including the sale and supply of any Products on the site. If this T&C conflicts with any other document, the T&C will prevail for the purposes of usage of the Site. If you do not agree to be bound by this T&C and the Privacy Policy, you may not use the Site in any way.
...
The Service is not available to minors under the age of 18 or to any users suspended or removed from the system by KOOVS.COM for any reason. Users may not have more than one account. Maintaining more than one account by a user shall amount to fraudulent act on part of the user and attract actions against such users. Additionally, users are prohibited from selling, trading, or otherwise transferring your KOOVS.COM account to another party. If you do not qualify, you may not use the Service or the Site.
...
In consideration of your use of the Site, you represent that you are of legal age to form a binding contract and are not a person barred from receiving services under the laws as applicable in India. You also agree to provide true, accurate, current and complete information about yourself as prompted by the Site's registration form. If you provide any information that is untrue, inaccurate, not current or incomplete (or becomes untrue, inaccurate, not current or incomplete), or KOOVS.COM has reasonable grounds to suspect that such information is untrue, inaccurate, not current or incomplete, KOOVS.COM has the right to suspend or terminate your account and refuse any and all current or future use of the Site (or any portion thereof). If you use the Site, you are responsible for maintaining the confidentiality of your account and password including cases when it is being used by any of your family members, friends or relatives, whether a minor or an adult. You further agree to accept responsibility for all transactions made from your account and any dispute arising out of any misuse of your account, whether by any family member, friend, relative, any third party or otherwise shall not be entertained by the Company. Because of this, we strongly recommend that you exit from your account at the end of each session. You agree to notify KOOVS.COM immediately of any unauthorized use of your account or any other breach of security. KOOVS.COM reserves the right to refuse service, terminate accounts, or remove or edit content in its sole discretion.

Introduction to KOOVS
The website, Koovs.com is operated under license by Marble E-Retail Pvt Ltd, a company duly incorporated under the Companies Act, 1956 of India and having its office at 75D, Gate No. 2, Sector 18, Gurgaon – 122015, India. Contact us at care@m-eretail.com or phone 0124-6770000

“KOOVS” is a registered trade mark.

Privacy Policy and Other Policies / Statements
By subscribing to or using any of our services, you hereby agree to have read and understood the privacy policy and other policies, statements and information put on the website.

<h6><b>Prohibitions</b></h6>
...
The content available on this website is under worldwide copyright protection laws and hence is the sole property of KOOVS. Modification, misuse, translation or creation of derivative work on the basis of website content is highly prohibited.

Koovs.com grants you a limited license to access and make personal use of the Site and the Service. This license does not include any downloading or copying of account information for the benefit of another vendor or any other third party; caching, unauthorized hypertext links to the Site and the framing of any Content available through the Site uploading, posting, or transmitting any content that you do not have a right to make available (such as the intellectual property of another party); uploading, posting, or transmitting any material that contains software viruses or any other computer code, files or programs designed to interrupt, destroy or limit the functionality of any computer software or hardware or telecommunications equipment; any action that imposes or may impose (in KOOVS.COM sole discretion) an unreasonable or disproportionately large load on KOOVS.COM infrastructure; or any use of data mining, robots, or similar data gathering and extraction tools. You may not bypass any measures used by KOOVS.COM to prevent or restrict access to the Site. Any unauthorized use by you shall terminate the permission or license granted to you by KOOVS.COM.

Registration & Security
Once registered, you will receive a confirmation mail on your registered email address.
...
You will notify Koovs.com of any unauthorized use of your password or account or any other breach of security.
Koovs.com cannot and will not be liable for any loss or damage arising from your failure to comply.
Terms of Sale
Once you place an order with KOOVS, you thus agree to abide by the following terms and conditions:

All the orders placed with us are subject to availability of the desired product.
Once an order is placed, an acknowledgement e-mail stating the confirmation of your order will be received by you. Please note that this acknowledgement does not mean the acceptance of your order. Your order is only accepted once the payment is received from your credit/debit card/account.
A standard authorization check is carried out on your payment card once your order is received by us. This is done solely to make sure that you have sufficient funds and thus your transaction can be carried out without any hindrance.
We make our best efforts to ensure that the product descriptions and set prices are accurate. However, error may occur. If it is discovered by us that the mentioned price at which you placed the order is incorrect, you will be informed by us at the earliest. You will be given the following two options –
You can reconfirm your order at the corrected new price;
If you do not wish to make the purchase any longer, you can cancel your order;
Free delivery may be subject to minimum order value as per the Shipping Policy;
...
We strive to provide you with the best prices possible on products and/or services you buy from KOOVS.COM, however, KOOVS.COM does not guarantee that the price will be the lowest in the city, region or geography. Prices and availability are subject to change without any prior notice. The prices mentioned on the Site are not subject to comparison with the same or similar product(s) and/or service(s) available through any online or offline sale. The pricing is subject to KOOVS.COM pricing policy and the prices shall be determined only at KOOVS.COM sole discretion.
While KOOVS.COM strives to provide accurate product and pricing information, typographical errors may occur. In the event that a product is listed at an incorrect price or with incorrect information due to an error in pricing or product information, KOOVS.COM may, at its discretion, either contact you for instructions or cancel your order and notify you of such cancellation. KOOVS.COM will have the right to modify the price of the product and contact you for further instructions using the e-mail address or telephone number provided by you during the time of registration, or cancel the order and notify you of such cancellation.
By using this Site, the User agrees to comply with all of the T&C hereof. The right to use the Site is personal to the User and is not transferable to any other person or entity. The User shall be responsible for protecting the confidentiality of their password(s), if any. The User acknowledges that, although the internet is often a secure environment, sometimes there are interruptions in service or events that are beyond the control of the Company, and the Company shall not be responsible for any data lost while transmitting information on the internet. While it is the Company's objective to make the Site accessible 24 hours per day, 7 days per week, the Site may be unavailable from time to time for any reason including, without limitation, routine maintenance. You understand and acknowledge that due to circumstances both within and outside of the control of the Company, access to the Site may be interrupted, suspended or terminated from time to time. The Company shall have the right at any time to change or discontinue any aspect or feature of the Site, including, but not limited to, content, hours of availability and equipment needed for access or use. Further, the Company may discontinue disseminating any portion of information or category of information may change or eliminate any transmission method and may change transmission speeds or other signal characteristics.
...
This agreement shall be governed by and interpreted and construed in accordance with the laws of India. The place of jurisdiction shall be in Gurgaon, Haryana.

Unless otherwise specified, the material on Koovs.com is presented solely for the purpose of sale India. Koovs.com makes no representation of the materials that are appropriate or available for use in other locations/Countries other than India. Those who choose to access this site from other locations/Countries other than India do so on their own will and Koovs.com is not responsible for supply of goods/refund for the goods ordered from other locations/Countries other than India, compliance with local laws, if and to the extent local laws are applicable.

Guarantee of Products/Services
Koovs.com hereby disclaims any guarantee of the accuracy in terms of finish and appearance of the final product as ordered by the user. The quality of any products, services, information, or other material purchased or obtained by you through the website may not meet your expectations.

Imitation of Liability
Koovs.com will not be responsible or liable for any special, incidental, indirect or consequential damages of any kind in connection with this agreement, even if Koovs.com has been informed in advance.
